...
--
-- Client :  localhost
-- Généré le :  Lun 02 Mai 2022 à 18:47
...
CREATE TABLE `comptable` (
  ...
  `clogin` char(20) CHARACTER SET utf8mb4 DEFAULT NULL,
...
INSERT INTO `comptable` (`cid`, `cnom`, `cprenom`, `clogin`, `cmdp`) VALUES
('a001', 'DUPON', 'Marcel', 'dmarcel', '4TH7zu'),
...
('a131', '202101', 0, '0.00', '2021-03-12', 'CL'),
('a131', '202103', 0, '0.00', '2021-05-07', 'CL'),
('a131', '202105', 0, '0.00', '2022-05-01', 'CL'),
('a131', '202205', 0, '0.00', '2022-05-01', 'CR');
...
INSERT INTO `lignefraishorsforfait` (`id`, `idVisiteur`, `mois`, `libelle`, `dateFrais`, `montant`) VALUES
(3, 'a131', '202101', 'Repas repr&eacute;sentation', '2020-05-14', '156.00'),
(4, 'a131', '202105', 'crevaison', '2021-05-03', '60.00');
...
('a131', 'Villechalane', 'Louis', 'lvillechalane', 'jux7g', '8 rue des Charmes', '46000', 'Cahors', '2005-12-21'),
